...
class _DiaperStock extends DiaperStock {
  const _DiaperStock({required this.count, required this.countedAt, this.alertThreshold = DiaperStock.defaultAlertThreshold, this.lastPackSize = DiaperStock.defaultPackSize}): super._();
