...
final timelineSleepsProvider = TimelineSleepsFamily._();
...
final class TimelineSleepsProvider
  ...
  TimelineSleepsProvider._({
    required TimelineSleepsFamily super.from,
  ...
  @override
  String toString() {
    return r'timelineSleepsProvider'
        ''
        '($argument)';
  }
  ...
  Stream<List<SleepSession>> create(Ref ref) {
    ...
    return timelineSleeps(ref, argument);
  }

  @override
  bool operator ==(Object other) {
    return other is TimelineSleepsProvider && other.argument == argument;
  }
...
String _$timelineSleepsHash() => r'c60191271816d500e711acede1d154633e563822';

/// Sommeils du Journal depuis [from] ; [from] doit être stable (minuit d'un jour).

final class TimelineSleepsFamily extends $Family
    with $FunctionalFamilyOverride<Stream<List<SleepSession>>, DateTime> {
  TimelineSleepsFamily._()
    : super(
        retry: noRetry,
        name: r'timelineSleepsProvider',
        dependencies: null,
  ...
  TimelineSleepsProvider call(DateTime from) =>
      TimelineSleepsProvider._(argument: from, from: this);

  @override
  String toString() => r'timelineSleepsProvider';
}
