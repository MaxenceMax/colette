...
mixin _$Household {
 ...
 String get code; DateTime get createdAt;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Household&&(identical(other.code, _this.code) || other.code == _this.code)&&(identical(other.createdAt, _this.createdAt) || other.createdAt == _this.createdAt));
}
...
int get hashCode {
  final _this = this as Household;
  return Object.hash(runtimeType,_this.code,_this.createdAt);
}

@override
String toString() {
  final _this = this as Household;
  return 'Household(code: ${_this.code}, createdAt: ${_this.createdAt})';
}
...
/// Create a copy of Household
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Household() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Household():
return $default(_that.code,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Household() when $default != null:
return $default(_that.code,_that.createdAt);case _:
  return null;
...
class _Household implements Household {
  const _Household({required this.code, required this.createdAt});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Household&&(identical(other.code, code) || other.code == code)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}


@override
int get hashCode {
    return Object.hash(runtimeType,code,createdAt);
}

@override
String toString() {
    return 'Household(code: $code, createdAt: $createdAt)';
}
...
/// Create a copy of Household
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? createdAt = null,}) {
